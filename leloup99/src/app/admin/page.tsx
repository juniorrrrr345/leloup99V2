    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="bg-gradient-to-br from-purple-900/20 to-blue-900/20 p-8 rounded-xl border border-purple-500/20">
          <h1 className="text-2xl font-bold text-white mb-6 text-center">LELOUP99 Admin</h1>
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          <h1 className="text-3xl font-bold">LELOUP99 Admin Panel</h1>
          <button
