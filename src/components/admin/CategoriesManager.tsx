      ...
      try {
        ...
        if (response.ok) {
          ...
          successMsg.textContent = productCount > 0 
            ? `✅ "${categoryName}" supprimée avec succès! (${productCount} produit(s) désassocié(s))`
            : `✅ "${categoryName}" supprimée avec succès!`;
          document.body.appendChild(successMsg);
