...
// DONNÉES GOTHAM
const MONGODB_URI = 'mongodb+srv://g42919380:gotham@cluster0.kxn4o4z.mongodb.net/idffull?retryWrites=true&w=majority&appName=Cluster0';
const MONGODB_DB_NAME = 'idffull'; // Base confirmée avec données
  ...
  try {
    ...
    for (const farm of uniqueFarms) {
      await executeSqlOnD1(
        ...
        [farm.name || 'Farm', 'Production GOTHAM', farm.location || farm.country || 'Local', 'contact@gotham.com']
      );
    }
    ...
    for (const product of uniqueProducts) {
      ...
      await executeSqlOnD1(
        ...
        [
          ...
          product.description || 'Produit GOTHAM de qualité',
          category_id,
          farm_id,
          product.image || '',
          product.video || '',
    ...
    console.log('✅ Settings GOTHAM configurés');
